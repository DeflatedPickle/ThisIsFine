...
public class MixinFireBlock {
     ...
     */
    @Overwrite
    public final void trySpreadingFire(World world, BlockPos pos, int spreadFactor, Random rand, int currentAge) {
        ThisIsFine.INSTANCE.trySpreadingFire((FireBlock) (Object) this, world, pos, spreadFactor, rand, currentAge);
    }
}
